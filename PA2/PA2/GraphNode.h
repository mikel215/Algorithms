...
protected:
    ...
    unordered_map<GraphNode<Key, Value>*, double> _vertices;
...
public:
    ...
    void addEdge(GraphNode<Key, Value> *node, double weight = 1)
    {
        _vertices[node] = weight;
    }

    unordered_map<GraphNode<Key, Value>*, double> getEdges()
    {
       return _vertices;
    }
